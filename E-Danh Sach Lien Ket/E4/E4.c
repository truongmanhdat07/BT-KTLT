...
int main(){
	...
	printf("Nhap so giang vien: "); scanf("%d",&n);
	nhapdanhsach(&dau,n);
...
float tinhtienday(giangvien *gv){
	...
	if(strcmp(gv->hocvi,"TS")==0){
		heso=1.5;
	}
	else if(strcmp(gv->hocvi,"ThS")==0){
		heso=1.0;
	}
	else{
		heso=0.5;
...
void indanhsach(giangvien *dau){
	...
	printf("========================================================================================\n");
	printf("| %-3s | %-25s | %-6s | %-8s | %-12s | %-15s |\n",
	       "STT","HO TEN","HOC VI","SO TIET","DON GIA","TIEN DAY");
	printf("========================================================================================\n");
	
	while(tam!=NULL){
		printf("| %-3d | %-25s | %-6s | %-8d | %-12.0f | %-15.0f |\n",
		       stt,
		       tam->hoten,
		       tam->hocvi,
		       tam->sotietday,
